export type IconName =
  | 'inbox' | 'mail' | 'mail-open' | 'star' | 'star-filled'
  | 'zap' | 'folder' | 'settings' | 'trash-2' | 'pencil'
  | 'link' | 'file-text' | 'image' | 'check' | 'check-circle'
  | 'x' | 'x-circle' | 'info' | 'play' | 'download'
  | 'arrows-left-right' | 'circle' | 'eye' | 'eye-off'
  | 'paperclip' | 'file' | 'film' | 'music' | 'archive'
  | 'table' | 'code' | 'grip-vertical';
...
const SVG: Record<IconName, string> = {
  ...
  'mail-open': `<path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/><path d="M2 7v13a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V7"/><path d="M22 7 12 2 2 7"/>`,
...
export function icon(name: IconName, size = 16, cls = ''): string {
  ...
  return `<svg${c} width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${SVG[name]}</svg>`;
}
